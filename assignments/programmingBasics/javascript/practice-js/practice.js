...
console.log(desk[2].items[0].type[0].colors);

// print 1 color of the item
console.log(desk[2].items[0].type[0].colors[0]);
...
// both have the same results but the latter breaks the loop if the targeted color is not found making the code more efficient
